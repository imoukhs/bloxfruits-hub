...
local QuestData = {
    ...
    {level = {31, 40},    island = "Jungle",           mobName = "Gorilla King",     mobArea = CFrame.new(-1240, 6, -411), npcArea = CFrame.new(-1613, 37, 152)},
    {level = {41, 60},    island = "Pirate Village",   mobName = "Pirate",           mobArea = CFrame.new(-1152, 5, 3826)},
